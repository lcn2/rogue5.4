...
```
    ...
    |    9   |    9 %    | drain life    | Drains half of the hero's hp, removes  |
    |        |           |               | health evenly visible from monsters.   |
    |    a   |    1 %    | nothing       | Doesn't do anything.                   |
    |    b   |    6 %    | teleport away | Teleports                              |
    |    c   |    6 %    | teleport to   | Teleports                              |
