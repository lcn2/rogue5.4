...
| symbol |    monster    | levels |  carry | flags |  exp |   HP | armor | damage           |
|--------|---------------|--------|--------|-------|------|------|-------|------------------|
|    A   | aquator       | 09..18 |    0 % | m     |   20 |  5d8 |   2   | 0x0 / 0x0        |
|    B   | bat           | 01..08 |    0 % | f     |    1 |  1d8 |   3   | 1x2              |
...
**each** of its attacks is attempted.  For example, a **D** (dragon),
which as a "**damage**" of "1x8 / 1x8 / 3x10", when it
attacks, will attempt 3 attacks of "1x8", and again of "1x8", and finally "3x10".

The "**HP**" indicates the amount of damage the monster will take before
it is killed.  A "**HP**" of "Cd8" means that "C" (also the base class) number of 8-sided dice
