...
/*
 * test_strlcpy - calc STRL_TEST test version of strlcpy
...
/*
 * test_strlcat - calc STRL_TEST test version of strlcat
...
main(int argc, char **argv)
{
    ...
    printf("src: %s\n", src);
    ret = test_strlcpy(dst, src, sizeof(dst));
    printf("ret: %zu\n", ret);
    printf("dst: %s\n\n", dst);
    ...
    memset(dst, 0, sizeof(dst));
    printf("src: %s\n", src);
    ret = test_strlcpy(dst, src, sizeof(dst) - 3);
    printf("ret: %zu\n", ret);
    printf("dst: %s\n\n", dst);
     ...
     */
    printf("src: %s\n", src);
    ret = test_strlcat(dst, src, sizeof(dst));
    printf("ret: %zu\n", ret);
    printf("dst: %s\n\n", dst);
    ...
    dst[1] = '\0';
    printf("src: %s\n", src);
    ret = test_strlcat(dst, src, sizeof(dst) - 3);
    printf("ret: %zu\n", ret);
    printf("dst: %s\n\n", dst);
