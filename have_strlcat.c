 ...
 *
 *      HAVE_STRLCAT
 *              defined ==> use strlcat() from libc
 *              undefined ==> use strlcat() code from strl.c
 */
...
main(void)
{
    ...
    printf("#undef HAVE_STRLCAT /* no - code from strl.c */\n");
    ...
    printf("#define HAVE_STRLCAT /* yes - use libc function */\n");
